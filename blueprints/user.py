...
class User(UserMixin):
    def __init__(
        ...
        **kwargs,
        ...
        self.roles = set(str(r).strip().upper() for r in (roles or []) if str(r).strip())

        # Banderas comunes usadas en templates
        self.is_admin = ("ADMINISTRADOR" in self.roles)
        self.is_rrhh = ("RRHH" in self.roles)
